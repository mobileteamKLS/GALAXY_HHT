...
class BuildUpAWBRemarkListAckPage extends StatefulWidget {
  ...
  BuildUpAWBDetailList aWBItem;
  int menuId;
  List<SubMenuName> importSubMenuList = [];
  List<SubMenuName> exportSubMenuList = [];

  BuildUpAWBRemarkListAckPage({super.key,
    required this.importSubMenuList,
    required this.exportSubMenuList,
    required this.mainMenuName,
    required this.aWBRemarkList,
    required this.aWBItem,
    required this.menuId});

  @override
  State<BuildUpAWBRemarkListAckPage> createState() => _BuildUpAWBRemarkListAckPageState();
}

class _BuildUpAWBRemarkListAckPageState extends State<BuildUpAWBRemarkListAckPage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    widget.aWBRemarkList?.sort((a, b) {
      if (b.isHighPriority == 1 && a.isHighPriority != 1) {
        return 1;
      } else if (b.isHighPriority != 1 && a.isHighPriority == 1) {
        return -1;
      } else {
        return 0;
      }
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: CircleAvatar(
                                                              radius: 10,
                                                              backgroundColor: (widget.aWBRemarkList![index].isHighPriority == 1)
                                                                  ? MyColor.colorRed
                                                                  : Colors.transparent,
                                                              child: CustomeText(
                                                                text: (widget.aWBRemarkList![index].isHighPriority == 1) ? "P" : "",
                                      ...
                                      Expanded(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 5),
                                            CustomeText(
                                              text: "${CommonUtils.formateToTwoDecimalPlacesValue(widget.aWBItem.weightKg!)} Kg",
                                              fontColor: MyColor.colorBlack,
                                              fontSize: SizeConfig.textMultiplier * SizeUtils.TEXTSIZE_1_5,
                                              fontWeight: FontWeight.w600,
                                              textAlign: TextAlign.start,
