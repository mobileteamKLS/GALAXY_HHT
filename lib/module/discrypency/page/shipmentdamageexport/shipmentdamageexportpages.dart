...
import 'package:galaxy/module/discrypency/services/shipmentdamageexport/shipmentdamageexportlogic/shipmentdamageexportlogic/shipmentdamageexpcubit.dart';
...
class ShipmentDamageExportPages extends StatefulWidget {
  String mainMenuName;
  String title;
  String refrelCode;
  ...
  @override
  State<ShipmentDamageExportPages> createState() => _ShipmentDamageExportPagesState();
}

class _ShipmentDamageExportPagesState extends State<ShipmentDamageExportPages> with SingleTickerProviderStateMixin{
  ...
  ShipmentDamageExportModel? shipmentDamageExportModel;
  ...
  Future<void> leaveGroupIdFocus() async {
    ...
    if (groupIdController.text.isNotEmpty) {
      ...
      await context.read<ShipmentDamageExpCubit>().getExpShipmentDamageDetailListApi(
      ...
      shipmentDamageExportModel = null;
      setState(() {
  ...
  Future<void> _loadUser() async {
    ...
    context.read<ShipmentDamageExpCubit>().getPageLoad(widget.menuId, _user!.userProfile!.userIdentity!, _splashDefaultData!.companyCode!);
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // start api responcer
                            BlocListener<ShipmentDamageExpCubit, ShipmentDamageExpState>(
                              listener: (context, state) async {
                                if(state is ShipmentDamageExpInitialState){

                                }else if(state is ShipmentDamageExpLoadingState){
                                  DialogUtils.showLoadingDialog(context, message: lableModel.loading);
                                }
                                else if(state is GetShipmentDamagePageLoadSuccessState){
                                  DialogUtils.hideLoadingDialog(context);
                                  if(state.shipmentDamageGetPageLoad.status == "E"){
                                    ...
                                    SnackbarUtil.showSnackbar(context, state.shipmentDamageGetPageLoad.statusMessage!, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                    Vibration.vibrate(duration: 500);
                                  }else{

                                    groupIDCharSize = state.shipmentDamageGetPageLoad.isGroupBasedAcceptNumber!;
                                    isGroupIDRequired = state.shipmentDamageGetPageLoad.isGroupBasedAcceptChar!;
                                ...
                                else if(state is GetShipmentDamagePageLoadFailureState){
                                  DialogUtils.hideLoadingDialog(context);
                                  SnackbarUtil.showSnackbar(context, state.error, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                  Vibration.vibrate(duration: 500);
                                }
                                else if(state is ShipmentDamageListExpSuccessState){
                                  DialogUtils.hideLoadingDialog(context);

                                  if(state.shipmentDamageExportModel.status == "E"){
                                    shipmentDamageExportModel = null;
                                    WidgetsBinding.instance.addPostFrameCallback((_) {
                                      FocusScope.of(context).requestFocus(groupIdFocusNode);
                                    },
                                    ...
                                    SnackbarUtil.showSnackbar(context, state.shipmentDamageExportModel.statusMessage!, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                    Vibration.vibrate(duration: 500);
                                  }
                                  else{

                                    if(state.shipmentDamageExportModel.damageDetailList == null){
                                      shipmentDamageExportModel = null;
                                      WidgetsBinding.instance.addPostFrameCallback((_) {
                                        FocusScope.of(context).requestFocus(groupIdFocusNode);
                                      },
                                      ...
                                      shipmentDamageExportModel = state.shipmentDamageExportModel;
                                ...
                                else if(state is ShipmentDamageListExpFailureState){
                                  DialogUtils.hideLoadingDialog(context);
                                  SnackbarUtil.showSnackbar(context, state.error, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                  Vibration.vibrate(duration: 500);
                                }
                                else if(state is RevokeDamageExpSuccessState){
                                  DialogUtils.hideLoadingDialog(context);
                                  if(state.revokeDamageExpModel.status == "E"){
                                    SnackbarUtil.showSnackbar(context, state.revokeDamageExpModel.statusMessage!, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                    Vibration.vibrate(duration: 500);
                                  }else{
                                    SnackbarUtil.showSnackbar(context, state.revokeDamageExpModel.statusMessage!, MyColor.colorGreen, icon: Icons.done);
                                    await context.read<ShipmentDamageExpCubit>().getExpShipmentDamageDetailListApi(
                                        groupIdController.text,
                                        searchByGroupOrAWB,
                                        _user!.userProfile!.userIdentity!,
                                ...
                                else if(state is RevokeDamageExpFailureState){
                                  DialogUtils.hideLoadingDialog(context);
                                  SnackbarUtil.showSnackbar(context, state.error, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                  Vibration.vibrate(duration: 500);
                                }
                                        ...
                                        Directionality(textDirection: textDirection,
                                            child: Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: (shipmentDamageExportModel != null)
                                                    ? (shipmentDamageExportModel!.damageDetailList!.isNotEmpty) ? Column(
                                                  children: [

                                                    ListView.builder(
                                                      itemCount: (shipmentDamageExportModel != null)
                                                          ? shipmentDamageExportModel!.damageDetailList!.length
                                                          : 0,
                                                      ...
                                                      itemBuilder: (context, index) {
                                                        DamageDetailList damageDetailList = shipmentDamageExportModel!.damageDetailList![index];
                                                            ...
                                                            onDoubleTap: () async {
                                                              ...
                                                              var value = await Navigator.push(context, CupertinoPageRoute(
                                                                builder: (context) => DamageShimentPage(
                                                                  ...
                                                                  iMPAWBRowId: damageDetailList.expAWBRowId!,
                                                                  iMPShipRowId: damageDetailList.expShipRowId!,
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      (damageDetailList.damageNOP != 0) ? RoundedButton(
                                                                                        ...
                                                                                        if(exitConfirmed == true) {
                                                                                          await context.read<ShipmentDamageExpCubit>().revokeExpDamageApi(
                                                                                              damageDetailList.expAWBRowId!,
                                                                                              damageDetailList.expShipRowId!,
