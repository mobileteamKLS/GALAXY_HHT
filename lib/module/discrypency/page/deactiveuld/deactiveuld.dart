...
import '../../services/deactiveuld/deactiveuldlogic/deactiveduldstate.dart';
import '../../services/deactiveuld/deactiveuldlogic/deactiveuldcubit.dart';


class DeactiveULDPage extends StatefulWidget {
  String mainMenuName;
  String title;
  String refrelCode;
  ...
  @override
  State<DeactiveULDPage> createState() => _DeactiveULDPageState();
}

class _DeactiveULDPageState extends State<DeactiveULDPage> with SingleTickerProviderStateMixin{
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // start api responcer
                            BlocListener<DeactiveULDCubit, DeactiveULDState>(
                              listener: (context, state) async {
                                if (state is DeactiveULDInitialState) {
                                }
                                else if (state is DeactiveULDLoadingState) {
                                  // showing loading dialog in this state
                                  DialogUtils.showLoadingDialog(context, message: lableModel.loading);
                                }
                                else if(state is GetDeactiveULDSearchSuccessState){
                                  DialogUtils.hideLoadingDialog(context);
                                  if(state.getULDSearchModel.status == "E"){
                                    Vibration.vibrate(duration: 500);
                                    SnackbarUtil.showSnackbar(context, state.getULDSearchModel.statusMessage!, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                ...
                                else if(state is GetDeactiveULDSearchFailureState){
                                  DialogUtils.hideLoadingDialog(context);
                                  Vibration.vibrate(duration: 500);
                                ...
                                else if(state is GetDeactiveSuccessState){
                                  DialogUtils.hideLoadingDialog(context);
                                  if(state.uldDeactivateModel.status == "E"){
                                    Vibration.vibrate(duration: 500);
                                    SnackbarUtil.showSnackbar(context, state.uldDeactivateModel.statusMessage!, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                    WidgetsBinding.instance.addPostFrameCallback((_) {
                                      FocusScope.of(context).requestFocus(groupIdFocusNode);
                                    });
                                  }else{
                                ...
                                else if(state is GetDeactiveFailureState){
                                  DialogUtils.hideLoadingDialog(context);
                                  Vibration.vibrate(duration: 500);
                                  SnackbarUtil.showSnackbar(context, state.error, MyColor.colorRed, icon: FontAwesomeIcons.times);
                                  WidgetsBinding.instance.addPostFrameCallback((_) {
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          SizedBox(height: SizeConfig.blockSizeVertical,),
                                                                          RoundedButtonBlue(text: "Record De-Activate",
                                                                            press: () async {
                                                                              getDeactiveULD(uldDetail.uLDSeqNo!, uldDetail.flightSeqNo!);
  ...
  Future<void> getDeactiveULDSearch() async {

    await context.read<DeactiveULDCubit>().getSearchDamagedULD(
  ...
  Future<void> getDeactiveULD(int uldSeqNo, int flightSeqNo) async {

    await context.read<DeactiveULDCubit>().getULDDeactivate(
        uldSeqNo,
        flightSeqNo,
        _user!.userProfile!.userIdentity!,
        _splashDefaultData!.companyCode!,
