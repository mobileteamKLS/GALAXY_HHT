...
class HAWBRemarkListAckPage extends StatefulWidget {
  ...
  @override
  State<HAWBRemarkListAckPage> createState() => _HAWBRemarkListAckPageState();
}

class _HAWBRemarkListAckPageState extends State<HAWBRemarkListAckPage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    widget.haWBRemarkList?.sort((a, b) {
    ...
    isExpandedList = List.filled(widget.haWBRemarkList!.length, false);
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                            ...
                                            child: Directionality(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  CustomeText(
                                                      text: "${lableModel.remarkfor} HAWB No. ${widget.haWBItem.houseNo}",
                                          ...
                                          (widget.haWBRemarkList!.isNotEmpty)
                                              ? Expanded(
                                            child: ListView.builder(
                                              itemCount: widget.haWBRemarkList!.length,
                                              itemBuilder: (context, index) {

                                                bool isTextMoreThanTwoLines = _isTextMoreThanTwoLines(
                                                  widget.haWBRemarkList![index].remark!,
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: CircleAvatar(
                                                              radius: 10,
                                                              backgroundColor: (widget.haWBRemarkList![index].isHighPriority == true)
                                                                  ? MyColor.colorRed
                                                                  : Colors.transparent,
                                                              child: CustomeText(
                                                                text: (widget.haWBRemarkList![index].isHighPriority == true) ? "P" : "",
                                                          ...
                                                          Expanded(
                                                            child: Text(widget.haWBRemarkList![index].remark!,
                                                              style: TextStyle(
                                                                  fontSize: SizeConfig.textMultiplier * SizeUtils.TEXTSIZE_1_5,
