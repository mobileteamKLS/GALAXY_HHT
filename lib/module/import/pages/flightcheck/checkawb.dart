...
class CheckAWBPage extends StatefulWidget {
  ...
  String uldNo;
  String mainMenuName;
  CheckAWBPage({super.key, required this.uldNo, required this.mainMenuName});
                                  ...
                                  children: [
                                    Directionality(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          CustomeText(text: "${lableModel.uldNo} ", fontColor: MyColor.colorBlack, fontSize: SizeConfig.textMultiplier * SizeUtils.TEXTSIZE_2_0, fontWeight: FontWeight.w600, textAlign: TextAlign.start),
                                          SizedBox(width: SizeConfig.blockSizeHorizontal * SizeUtils.BUTTONHORIZONTALSIZE,),
                                          CustomeText(text: widget.uldNo, fontColor: MyColor.colorBlack, fontSize: SizeConfig.textMultiplier * SizeUtils.TEXTSIZE_2_0, fontWeight: FontWeight.w600, textAlign: TextAlign.start),
                                        ],
                                      ),
                                    ),
