...
class RemarkCustomTextField extends StatefulWidget {
  ...
  @override
  State<RemarkCustomTextField> createState() => _RemarkCustomTextFieldState();
}

class _RemarkCustomTextFieldState extends State<RemarkCustomTextField> {
